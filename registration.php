...
$query = "INSERT INTO usersmarikina(username, password, name, user_lastname, email, user_phoneno, user_role,paycourse, user_image,type, status, date) VALUES('$username', '$password', '$name', '$lastname', '$email', '$phone_no', '$u_role','$pay_course', '$image', 'comment', 'unread', CURRENT_TIMESTAMP) ";
		...
		<div class="qr-code-container">
			<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=gcash://send%3Famount%3D50%26recip%3D09171234567%26memo%3DTest%20Payment" alt="GCash Payment QR Code">
		       ...
		       <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="email" value="TDC" name="pay_course" required readonly >
                </div>
