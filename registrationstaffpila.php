...
$query = "INSERT INTO userspila(username, password, name, user_lastname, email, user_phoneno, user_role,Not_approved,type, status, date) VALUES('$username', '$password', '$name', '$lastname', '$email', '$phone_no', '$u_role','$Not_approved', 'comment', 'unread', CURRENT_TIMESTAMP) ";
...
<body class="d-flex align-items-center justify-content-center" >
  ...
  <div class="container" style="margin-left:500px;" >
    <div class="row">
      ...
      <div class="col-lg-6">
        <h2 class="text-center">Registration-Staff Pila</h2>
