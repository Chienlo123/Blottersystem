...
<?php include "includes/sidebar.php"; ?>
        ...
        <div class="background-text">
            <h2 style="margin-top:-200px ">Driving School<span> Muntinlupa</span></h2>
			
        </div>
        <div class="taxi-image" style="margin-left:100px">
            <img style="width:550px; " src="images/y2.png" alt="">
        </div>
...
<div class="home-container">
    <div class="home-content">
        <div class="inner-content">
         ...
         <a href="contact.php" class="booknow">Contact Us:</a>
        </div>
        <div class="inner-content">
           <div id="header" class="shadow mb-4" >
              <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column px-3">
                  ...
                  <center ><a class="btn btn-lg btn-light rounded-pill w-25" id="enrollment"><img class="img-responsive" src="images/enroll2.png" alt=""></a></center>
				    <a href="registration.php" style="margin-left: 500px; margin-top: 10px; "class="btn btn-primary">Go to Registration</a>
