...
<?php include "includes/headerlaspinas.php"; ?>
    ...
    <div class="container" style="width: 50%;">
        ...
        <div id="Personel Details" class="tabcontent">
          ...
          $query = "SELECT * FROM userslaspinas where user_id = $curr_user_id";
        ...
        <div id="Edit Details" class="tabcontent">
          ...
          <?php
            ...
            if (isset($_POST['update-user'])) {
              ...
              $query = "UPDATE userslaspinas SET username='{$username}', password='{$password}', name='{$name}', user_lastname='{$user_lastname}', password='{$password}', user_phoneno={$user_phoneno}, email='{$email}', user_image='{$image}' WHERE user_id=$curr_user_id";
              ...
              header("Location:profilelaspinas.php");
            }
