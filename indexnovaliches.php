...
<head>
   ...
   <link rel="stylesheet" href="stylenovaliches.css">
...
<?php include "includes/sidebarnovaliches.php"; ?>

        <div class="background-text">
             <h2 style="margin-top:-200px ">Driving School<span> Novaliches</span></h2>
...
<div class="home-container">
    <div class="home-content">
        ...
        <a href="contactnovaliches.php" class="booknow">Contact Us:</a>
        </div>
        <div class="inner-content">
           <div id="header" class="shadow mb-4" >
              <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column px-3">
                  ...
                  <center ><a class="btn btn-lg btn-light rounded-pill w-25" id="enrollment"><img class="img-responsive" src="images/enroll2.png" alt=""></a></center>
				    <a href="registrationnovaliches.php" style="margin-left: 500px; margin-top: 10px; "class="btn btn-primary">Go to Registration</a>
