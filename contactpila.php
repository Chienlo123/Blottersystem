...
<body>
    <div class="fcf-body">
        <h3 style="text-align:center; font-weight: 600; font-size: 40px;">Contact us Pila</h3>
    ...
    if (isset($_POST['submit'])) {
        if (!empty($_POST['name']) && !empty($_POST['email'] && !empty($_POST['message']))) {
            ...
            $query = "INSERT INTO contactpila(name, email, message) VALUES ('$name', '$email', '$message')";
