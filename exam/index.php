...
<div class="back-button">
	<a href="../admin/index.php" class="label">Back</a>
</div>
...
<!-- Text input-->
<center><h1>Sign-Up Account for Exam</h1></center>
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="gender" name="gender" placeholder="Enter Gender" class="form-control input-md" >
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter Address" class="form-control input-md" type="text">
