...
<?php include "includes/headerlaspinas.php"; ?>
...
$query = "INSERT INTO userslaspinas(username, password, name, user_lastname, email, user_phoneno, user_role,paycourse, user_image,type, status, date) VALUES('$username', '$password', '$name', '$lastname', '$email', '$phone_no', '$u_role','$pay_course', '$image', 'comment', 'unread', CURRENT_TIMESTAMP) ";
...
if(!$register_user) {
 ...
 echo "<script>alert('You Are Successfully Register  Please go to Login ')</script>";
                  ...
                  echo "<script> document.location.href='admin/reportlaspinas.php';</script>";
