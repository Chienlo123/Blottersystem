...
<div id="wrapper">
            ...
            <div class="row">
                <!-- Total Users Box -->
					...
					<div class="card bg-warning text-white info-box-3d">
						...
						<a href="../admin/userslaspinasaccept.php" class="card-link text-white">View Details</a>
					</div>
				</div>
                ...
                <div class="col-md-3">
                    <div class="card bg-info text-white info-box-3d">
                        ...
                        <a href="../admin/Learnerslaspinasaccept.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white info-box-3d">
                        ...
                        <a href="../admin/reportlaspinas.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-danger text-white info-box-3d">
                        ...
                        <a href="../admin/querylaspinas.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
            </div>
    ...
    <div class="card bg-danger text-white info-box-3d" style="margin-left:-10px; margin-right:10px;">
        ...
        <a href="../admin/categorieslaspinas.php" class="card-link text-white">View Details</a>
    </div>
</div>
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphlaspinas/data1.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphlaspinas/data2.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphlaspinas/data3.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphlaspinas/data4.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphlaspinas/data5.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphlaspinas/data6.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
