                            ...
                            default: ?>
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        $query = "SELECT *  FROM  posts where confirm = 'Not_Complete'order by post_id desc";
...
<div class="modal fade" id="myModal">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <a href="Learners.php?delete=<?php echo $Learners_id; ?>" class="btn btn-danger btn-block">Delete</a>
        </li>
        <li class="list-group-item">
            <a href="Learners.php?source=update&Learners_id=<?php echo $Learners_id; ?>" class="btn btn-primary btn-block">Update</a>
        </li>
        <li class="list-group-item">
            <a href="Learners.php?Complete=<?php echo $Learners_id; ?>" class="btn btn-success btn-block">Complete</a>
        </li>
        <li class="list-group-item">
            <a href="Learners.php?Not_Complete=<?php echo $Learners_id; ?>" class="btn btn-warning btn-block">Not Complete</a>
        </li>
    </ul>
</div>
