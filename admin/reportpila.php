...
<div id="wrapper">
            ...
            <div class="row">
                <!-- Total Users Box -->
					...
					<div class="card bg-warning text-white info-box-3d">
						...
						<a href="../admin/userspilaaccept.php" class="card-link text-white">View Details</a>
					</div>
				</div>
                ...
                <div class="col-md-3">
                    <div class="card bg-info text-white info-box-3d">
                        ...
                        <a href="../admin/Learnerspilaaccept.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white info-box-3d">
                        ...
                        <a href="../admin/reportpila.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-danger text-white info-box-3d">
                        ...
                        <a href="../admin/querypila.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
            </div>
    ...
    <div class="card bg-danger text-white info-box-3d" style="margin-left:-10px; margin-right:10px;">
        ...
        <a href="../admin/categoriespila.php" class="card-link text-white">View Details</a>
    </div>
</div>
