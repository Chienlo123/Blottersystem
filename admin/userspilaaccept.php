        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    switch ($source) {
                        case 'update_user':
                            include "includes/update_userpila.php";
                            break;
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                     <?php 
                                         ...
                                         $query = "SELECT *  FROM  userspila where user_role = 'Enroll' order by user_id desc";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
										...
										<div class="list-group">
											<ul class="list-group">
												<li class="list-group-item">
													<a href='userspilaaccept.php?delete=<?php echo $user_id; ?>' class="btn btn-danger btn-block">Delete</a>
												</li>
												<li class="list-group-item">
													<a href='userspilaaccept.php?source=update_user&user_id=<?php echo $user_id; ?>' class="btn btn-primary btn-block">Update</a>
												</li>
												<li class="list-group-item">
													<a href='userspilaaccept.php?Enroll=<?php echo $user_id; ?>' class="btn btn-success btn-block">Enroll</a>
												</li>
												<li class="list-group-item">
													<a href='userspilaaccept.php?Not_Enroll=<?php echo $user_id; ?>' class="btn btn-warning btn-block">Not Enroll</a>
												</li>
											</ul>
										</div>
									</div>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        header("Location: userspilaaccept.php");
                    }
                    ?>
                    <?php
                    if (isset($_GET['Not_Enroll'])) {
                        $user_id = $_GET['Not_Enroll'];
                        $query = "UPDATE userspila SET user_role = 'Not Enroll' WHERE user_id = '$user_id'";
                    ...
                    if (isset($_GET['Enroll'])) {
                        $user_id = $_GET['Enroll'];
                        $query = "UPDATE userspila SET user_role = 'Enroll' WHERE user_id = '$user_id'";
                        $add_admin = mysqli_query($connection, $query);
                        if (!$add_admin) {
                            die("Query Failed" . mysqli_error($connection));
                        }
