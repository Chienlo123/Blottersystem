                    ...
                    <div class="col-lg-12">
                            ...
                            default: ?>
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        $query = "SELECT *  FROM  postsnovaliches where confirm = 'Not_Complete'order by post_id desc";
                        ...
                        <?php 
                           ...
                           if (isset($_GET['delete'])) {
                            ...
                            header("Location: Learnersnovaliches.php");
                        }
...
<div class="modal fade" id="myModal">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <a href="Learnersnovaliches.php?delete=<?php echo $Learners_id; ?>" class="btn btn-danger btn-block">Delete</a>
        </li>
        <li class="list-group-item">
            <a href="Learnersnovaliches.php?source=update&Learners_id=<?php echo $Learners_id; ?>" class="btn btn-primary btn-block">Update</a>
        </li>
        <li class="list-group-item">
            <a href="Learnersnovaliches.php?Complete=<?php echo $Learners_id; ?>" class="btn btn-success btn-block">Complete</a>
        </li>
        <li class="list-group-item">
            <a href="Learnersnovaliches.php?Not_Complete=<?php echo $Learners_id; ?>" class="btn btn-warning btn-block">Not Complete</a>
        </li>
    </ul>
</div>
