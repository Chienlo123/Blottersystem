                    ...
                    switch ($source) {
                        ...
                        default:
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM  postsadmin order by post_id desc";
    ...
    <div class="list-group">
        <ul class="list-group">
            <li class="list-group-item">
                <a href='Learnersadmin.php?delete=<?php echo $Learners_id; ?>' class="btn btn-danger btn-block">Delete</a>
            </li>
            <li class="list-group-item">
                <a href='Learnersadmin.php?source=update&Learners_id=<?php echo $Learners_id; ?>' class="btn btn-primary btn-block">Update</a>
            </li>
            <li class="list-group-item">
                <a href='Learnersadmin.php?Complete=<?php echo $Learners_id; ?>' class="btn btn-success btn-block">Complete</a>
            </li>
            <li class="list-group-item">
                <a href='Learnersadmin.php?Not_Complete=<?php echo $Learners_id; ?>' class="btn btn-warning btn-block">Not Complete</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        header("Location: Learnersadmin.php");
                    }
                    ?>
                    <?php
