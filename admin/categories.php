    ...
    <div id="page-wrapper" >
       ...
       <h1 class="page-header">
                                                                    ...
                                                                    <div class="list-group">
                                                                        <ul class="list-group">
                                                                            <li class="list-group-item">
                                                                                <a href='categories.php?delete=<?php echo $cat_id; ?>' class="btn btn-danger btn-block">Delete</a>
                                                                            </li>
                                                                            <li class="list-group-item">
                                                                                <a href='categories.php?source=update_user&cat_id=<?php echo $cat_id; ?>' class="btn btn-primary btn-block">Update</a>
                                                                            </li>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $query = "DELETE FROM categories WHERE cat_id = {$user_idd} ";
