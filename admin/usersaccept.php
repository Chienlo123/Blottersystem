            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        ...
                        <small>Requirements Muntinlupa</small>
                    </h1>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                     <?php 
                                        ...
                                        $query = "SELECT *  FROM  usersmarikina where user_role = 'Enroll'  order by user_id desc";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
										...
										<div class="list-group">
											<ul class="list-group">
												<li class="list-group-item">
													<a href='users.php?delete=<?php echo $user_id; ?>' class="btn btn-danger btn-block">Delete</a>
												</li>
												<li class="list-group-item">
													<a href='users.php?source=update_user&user_id=<?php echo $user_id; ?>' class="btn btn-primary btn-block">Update</a>
												</li>
												<li class="list-group-item">
													<a href='users.php?Enroll=<?php echo $user_id; ?>' class="btn btn-success btn-block">Enroll</a>
												</li>
												<li class="list-group-item">
													<a href='users.php?Not_Enroll=<?php echo $user_id; ?>' class="btn btn-warning btn-block">Not Enroll</a>
												</li>
											</ul>
										</div>
									</div>
                    ...
                    if (isset($_GET['Not_Enroll'])) {
                        ...
                        header("Location: usersaccept.php");
                    }
                    ?>
                    <?php
