            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    switch ($source) {
                        ...
                        default: ?>
                            <table class="table table-bordered table-hover">
                                ...
                                $query = "SELECT *  FROM  feedbacklaspinas order by id desc";
                                ...
                                while ($row = mysqli_fetch_assoc($select_posts)) {
                                    ...
                                    <tr>
                                        ...
                                        <?php echo "<td><a href='feedbacklaspinas.php?delete=$id' class='btn btn-danger'>Delete</a></td>"; ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $query = "DELETE FROM feedbacklaspinas WHERE id = {$id} ";
                        ...
                        header("Location: feedbacklaspinas.php");
                    }
