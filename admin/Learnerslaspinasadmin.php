        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
										...
										<div class="list-group">
											<ul class="list-group">
												<li class="list-group-item">
													<a href='Learnerslaspinasadmin.php?delete=<?php echo $Learners_id; ?>' class="btn btn-danger btn-block">Delete</a>
												</li>
												<li class="list-group-item">
													<a href='Learnerslaspinasadmin.php?source=update&Learners_id=<?php echo $Learners_id; ?>' class="btn btn-primary btn-block">Update</a>
												</li>
												<li class="list-group-item">
													<a href='Learnerslaspinasadmin.php?Complete=<?php echo $Learners_id; ?>' class="btn btn-success btn-block">Complete</a>
												</li>
												<li class="list-group-item">
													<a href='Learnerslaspinasadmin.php?Not_Complete=<?php echo $Learners_id; ?>' class="btn btn-warning btn-block">Not Complete</a>
												</li>
											</ul>
										</div>
									</div>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        header("Location: Learnerslaspinasadmin.php");
                    }
                    ?>
                    <?php
