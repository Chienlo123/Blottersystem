                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Not_Complete Requirements</small>
                        </h1>
                            ...
                            default: ?>
                                ...
                                <tbody>
                                    ...
                                    <?php 
										...
										$query = "SELECT *  FROM  postslaspinas where confirm = 'Not_Complete' order by post_id desc";
...
<div class="modal fade" id="myModal">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <a href="Learnerslaspinas.php?delete=<?php echo $Learners_id; ?>" class="btn btn-danger btn-block">Delete</a>
        </li>
        <li class="list-group-item">
            <a href="Learnerslaspinas.php?source=update&Learners_id=<?php echo $Learners_id; ?>" class="btn btn-primary btn-block">Update</a>
        </li>
        <li class="list-group-item">
            <a href="Learnerslaspinas.php?Complete=<?php echo $Learners_id; ?>" class="btn btn-success btn-block">Complete</a>
        </li>
        <li class="list-group-item">
            <a href="Learnerslaspinas.php?Not_Complete=<?php echo $Learners_id; ?>" class="btn btn-warning btn-block">Not_Complete</a>
        </li>
    </ul>
</div>
