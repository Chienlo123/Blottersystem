                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                     <?php 
                                         ...
                                         $query = "SELECT *  FROM  usersnovaliches where user_role = 'Enroll' order by user_id desc";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
										...
										<div class="list-group">
											<ul class="list-group">
												<li class="list-group-item">
													<a href='usersnovalichesaccept.php?delete=<?php echo $user_id; ?>' class="btn btn-danger btn-block">Delete</a>
												</li>
												<li class="list-group-item">
													<a href='usersnovalichesaccept.php?source=update_user&user_id=<?php echo $user_id; ?>' class="btn btn-primary btn-block">Update</a>
												</li>
												<li class="list-group-item">
													<a href='usersnovalichesaccept.php?Enroll=<?php echo $user_id; ?>' class="btn btn-success btn-block">Enroll</a>
												</li>
												<li class="list-group-item">
													<a href='usersnovalichesaccept.php?Not_Enroll=<?php echo $user_id; ?>' class="btn btn-warning btn-block">Not Enroll</a>
												</li>
											</ul>
										</div>
									</div>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        header("Location: usersnovalichesaccept.php");
                    }
                    ?>
                    <?php
