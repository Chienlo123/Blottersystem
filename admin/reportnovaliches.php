...
<div id="wrapper">
            ...
            <?php
                       $curr_date = date('Y-m-d');
                        ...
                        $total_contact = mysqli_num_rows($get_contact);
						 ...
						 $query = "SELECT * FROM categoriesnovaliches ";
            ...
            <div class="row">
                <!-- Total Users Box -->
					...
					<div class="card bg-warning text-white info-box-3d">
						...
						<a href="../admin/usersnovalichesaccept.php" class="card-link text-white">View Details</a>
					</div>
				</div>
                ...
                <div class="col-md-3">
                    <div class="card bg-info text-white info-box-3d">
                        ...
                        <a href="../admin/Learnersnovalichesaccept.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white info-box-3d">
                        ...
                        <a href="../admin/reportnovaliches.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card bg-danger text-white info-box-3d">
                        ...
                        <a href="../admin/querynovaliches.php" class="card-link text-white">View Details</a>
                    </div>
                </div>
            </div>
    ...
    <div class="card bg-danger text-white info-box-3d" style="margin-left:-10px; margin-right:10px;">
        ...
        <a href="../admin/categoriesnovaliches.php" class="card-link text-white">View Details</a>
    </div>
</div>
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphnovaliches/data1.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphnovaliches/data2.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphnovaliches/data3.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphnovaliches/data4.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphnovaliches/data5.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"bargraphnovaliches/data6.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
