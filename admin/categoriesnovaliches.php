...
<!-- Add Categories and Descriptions Modal -->
    ...
    <div id="page-wrapper" >
       ...
       <h1 class="page-header">
                    ...
                    switch ($source) {
                        case 'update_user':
                            include "includes/update_categoriesnovaliches.php";
                            break;
						case 'add_categ':
                            include "includes/add_categoriesnovaliches.php";
                            break;
                        ...
                        default:
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover custom-table">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM categoriesnovaliches order by cat_id desc";
                                                                    ...
                                                                    <div class="list-group">
                                                                        <ul class="list-group">
                                                                            <li class="list-group-item">
                                                                                <a href='categoriesnovaliches.php?delete=<?php echo $cat_id; ?>' class="btn btn-danger btn-block">Delete</a>
                                                                            </li>
                                                                            <li class="list-group-item">
                                                                                <a href='categoriesnovaliches.php?source=update_user&cat_id=<?php echo $cat_id; ?>' class="btn btn-primary btn-block">Update</a>
                                                                            </li>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $query = "DELETE FROM categoriesnovaliches WHERE cat_id = {$user_idd} ";
                        $delete_Learners = mysqli_query($connection, $query);
                        if (!$delete_Learners) {
                            die("Query Failed" . mysqli_error($delete_Learners));
                        }
                        header("Location: categoriesnovaliches.php");
                    }
                    ?>
                </div>
            </div>
