...
<a class="navbar-brand" href="indexlaspinas.php"  style="margin-left:220px; font-size:20px;"> System Admin Laspinas</a>
    ...
    <li class="nav-item dropdown">
        <a class="nav-link" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Notifications
            <?php
            $query = "SELECT * from `userslaspinas` where `status` = 'unread' order by `date` DESC";
    ...
    <?php
    $query = "SELECT * FROM `userslaspinas` ORDER BY `date` DESC";
    ...
    if (count($notifications) > 0) {
        foreach ($notifications as $notification) {
            ...
            <a class="dropdown-item <?php echo $statusClass; ?>"
               href="includes/Notificationslaspinas/view.php?user_id=<?php echo $notification['user_id'] ?>">
...
<li class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a  href="userslaspinasaccept.php" >Enroll Student</a></li>
    <li><a href="userslaspinas.php" >Not_Enroll Student</a></li>
	 <li><a href="usersstaffapprovedlaspinas.php" >Staff Approved</a></li>
	 <li><a href="usersstafflaspinas.php" >Staff Not Approved</a></li>
  </ul>
</li>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="categorieslaspinas.php" >Categories</a></li>
    <li><a href="add_categorieslaspinas.php" >Add Categories</a></li>
  </ul>
</li>
		  ...
		  <ul class="dropdown-menu">
			...
			<li><a  href="../registrationlaspinas.php" >Registration Users</a></li>
			<li><a href="../registrationstafflaspinas.php" >Registration Staff</a></li>
		  </ul>
		</li>
		  		...
		  		<li class="dropdown">
					...
					<ul class="dropdown-menu" >
						...
						<li><a href="Learnerslaspinasaccept.php">Req Accepted</a></li>
						<li><a href="Learnerslaspinas.php">Req Pending</a></li>
						<li><a href="Learnerslaspinas.php?source=add_Learners" >Add Requirements</a></li>
					</ul>
				</li>
		 
		
        <li>
		  <a href="../Exam1laspinas/index.php">
		 ...
		 <li>
          <a href="../admin/feedbacklaspinas.php">
