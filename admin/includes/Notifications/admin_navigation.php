...
<a class="navbar-brand" href="index.php"  style="margin-left:220px; font-size:20px;"> System Admin Muntinlupa</a>
    ...
    <li class="nav-item dropdown">
        <a class="nav-link" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Notifications
            <?php
            $query = "SELECT * from `usersmarikina` where `status` = 'unread' order by `date` DESC";
    ...
    <?php
    $query = "SELECT * FROM `usersmarikina` ORDER BY `date` DESC";
    ...
    if (count($notifications) > 0) {
        foreach ($notifications as $notification) {
            ...
            <a class="dropdown-item <?php echo $statusClass; ?>"
               href="includes/Notifications/view.php?user_id=<?php echo $notification['user_id'] ?>">
...
<li class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a  href="usersaccept.php" >Enroll Student</a></li>
    <li><a href="users.php" >Not_Enroll Student</a></li>
	 <li><a href="usersstaffapproved.php" >Staff Approved</a></li>
	 <li><a href="usersstaff.php" >Staff Not Approved</a></li>
  </ul>
</li>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="add_categories.php" >Add Categories</a></li>
		  ...
		  <ul class="dropdown-menu">
			...
			<li><a  href="../registration.php" >Registration Users</a></li>
			<li><a href="../registrationstaff.php" >Registration Staff</a></li>
		  </ul>
		</li>
		  		...
		  		<li class="dropdown">
					...
					<ul class="dropdown-menu" >
						...
						<li><a href="Learnersaccept.php">Req Accepted</a></li>
						<li><a href="Learners.php">Req Pending</a></li>
						<li><a href="Learners.php?source=add_Learners" >Add Requirements</a></li>
					</ul>
				</li>
		 
		
        <li>
		  <a href="../Exam1/index.php">
