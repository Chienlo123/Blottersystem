...
$query = "SELECT *  FROM  usersnovaliches WHERE user_id=$edit_user_id";
...
if (isset($_POST['update-user'])) {
	...
	$query = "UPDATE usersnovaliches SET name = '$name', user_lastname = '$user_lastname' , payment = '$payment'  WHERE user_id=$edit_user_id ";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="category">Payment</label>
