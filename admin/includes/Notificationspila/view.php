...
<body>
    <div class="container mt-4">
        ...
        $query ="UPDATE `userspila` SET `status` = 'read' WHERE `user_id` = $user_id;";
        performQuery($query);

        $query = "SELECT * from `userspila` where `user_id` = '$user_id';";
        ...
        <br/>
        <a href="../../reportpila.php" class="btn btn-primary">Back</a>
    </div>
</body>
</html>
