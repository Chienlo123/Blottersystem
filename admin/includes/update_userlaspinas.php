...
$query = "SELECT *  FROM  userslaspinas WHERE user_id=$edit_user_id";
...
if (isset($_POST['update-user'])) {
	...
	$query = "UPDATE userslaspinas SET name = '$name', user_lastname = '$user_lastname' , payment = '$payment'  WHERE user_id=$edit_user_id ";
