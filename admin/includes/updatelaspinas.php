...
if (isset($_POST['update-Learners'])) {
	...
	$query = "UPDATE postslaspinas SET post_title='{$Learners_Name}',  Address='{$Address}',  ADL='{$ADL}',  PSA_NSO='{$PSA_NSO}',  medicalcerti='{$medicalcerti}', post_author='{$admin}', post_category_id={$category}, post_content='{$detail}' WHERE post_id=$edit_Learners_id ";
