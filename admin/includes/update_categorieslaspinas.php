...
$query = "SELECT * FROM categorieslaspinas WHERE cat_id = $edit_user_id";
...
if (isset($_POST['update-user'])) {
    ...
    $query = "UPDATE categorieslaspinas SET cat_title = '$cat_title', description = '$description', wheels = '$wheels' WHERE cat_id = $edit_user_id";
