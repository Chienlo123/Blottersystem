...
$query = "SELECT * FROM categories WHERE cat_id = $edit_user_id";
...
if (isset($_POST['update-user'])) {
    ...
    $query = "UPDATE categories SET cat_title = '$cat_title', description = '$description', wheels = '$wheels' WHERE cat_id = $edit_user_id";
