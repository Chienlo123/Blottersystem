...
<a class="navbar-brand" href="indexadmin.php"  style="margin-left:220px; font-size:20px;"> System Admin</a>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu" >
            <li>
                <a href="../profileadmin.php"><i class="fa fa-fw fa-user"></i> Profile</a>
				  <a href="../includes/logoutadmin.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
            </li>
      ...
      <ul class="nav-list">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					...
					<li><a  href="usersadmin.php" >Users Marikina</a></li>
					<li><a href="userslaspinasadmin.php" >Users Laspinas</a></li>
					<li><a href="usersnovalichesadmin.php" >Users novaliches</a></li>
					<li><a  href="userspilaadmin.php" >Users Pila</a></li>
				  </ul>
				</li>
		  		...
		  		<li class="dropdown">
					...
					<ul class="dropdown-menu" >
						...
						<li><a href="Learnersadmin.php"> Req Marikina</a></li>
						<li><a href="Learnerslaspinasadmin.php">Req Laspinas</a></li>
						<li><a href="Learnersnovalichesadmin.php" >Req Novaliches</a></li>
						<li><a href="Learnerspilaadmin.php" > Req Pila</a></li>
					</ul>
				</li>
