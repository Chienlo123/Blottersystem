...
<body>
    <div class="container mt-4">
        ...
        $query ="UPDATE `usersnovaliches` SET `status` = 'read' WHERE `user_id` = $user_id;";
        performQuery($query);

        $query = "SELECT * from `usersnovaliches` where `user_id` = '$user_id';";
        ...
        <br/>
        <a href="../../reportnovaliches.php" class="btn btn-primary">Back</a>
    </div>
</body>
</html>
