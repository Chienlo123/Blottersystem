...
$query = "SELECT *  FROM  userspila WHERE user_id=$edit_user_id";
...
if (isset($_POST['update-user'])) {
	...
	$query = "UPDATE userspila SET name = '$name', user_lastname = '$user_lastname' , payment = '$payment'  WHERE user_id=$edit_user_id ";
