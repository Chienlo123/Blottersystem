...
<?php include "includes/headerpila.php"; ?>
    ...
    <div class="container" style="width: 50%;">
        ...
        <div id="Personel Details" class="tabcontent">
          ...
          $query = "SELECT * FROM userspila where user_id = $curr_user_id";
        ...
        <div id="Edit Details" class="tabcontent">
          ...
          <?php
            ...
            if (isset($_POST['update-user'])) {
              ...
              $query = "UPDATE userspila SET username='{$username}', password='{$password}', name='{$name}', user_lastname='{$user_lastname}', password='{$password}', user_phoneno={$user_phoneno}, email='{$email}', user_image='{$image}' WHERE user_id=$curr_user_id";
              ...
              header("Location:profilepila.php");
            }
