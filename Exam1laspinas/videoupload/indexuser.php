...
<body>
	...
	<a href="../../Exam1laspinas/account.php" class="label">Back</a>
</div>
	<div class="col-md-3" ></div>
	
	<div class="col-md-6 well" style="margin-top:50px;">
	
		<center><h3 class="text-primary">Exam Motorcycle Driving school</h3></center>
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `videolaspinas` ORDER BY `video_id` ASC") or die(mysqli_error());
