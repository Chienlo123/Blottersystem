...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2023 at 12:56 PM
...
INSERT INTO `categories` (`cat_id`, `cat_title`, `description`, `wheels`) VALUES
(8, 'Heavy Vehicles', '', ''),
(9, 'Light Vehicles', '', ''),
(10, 'Motorcycles', 'manual', ''),
(11, 'Motor Tricycles', 'authomatic', ''),
(13, 'Bike', 'manual', ''),
(123, 'wew', 'manual', ''),
(124, 'track', '', ''),
(125, 'track', '', ''),
...
(129, 'wew', 'manual', ''),
(130, 'Bike', 'automatic', ''),
(142, 'wew', 'manual', '2Wheels'),
(143, 'wew', 'manual', '2Wheels'),
(144, 'wew', 'manual', '2Wheels'),
(145, 'ebike', 'manual', '4Wheels'),
(146, 'ebike', 'manual', '4Wheels'),
(147, 'ebike', 'manual', '3Wheels'),
(148, 'ebike', 'manual', '2Wheels');
...
INSERT INTO `categorieslaspinas` (`cat_id`, `cat_title`, `description`, `wheels`) VALUES
(6, 'ebike', 'manual', ''),
(7, 'track', 'manual', '');
...
--
-- Dumping data for table `categoriesnovaliches`
--

INSERT INTO `categoriesnovaliches` (`cat_id`, `cat_title`, `description`, `wheels`) VALUES
(4, 'ebike', 'manual', '');
...
INSERT INTO `categoriespila` (`cat_id`, `cat_title`, `description`, `wheels`) VALUES
(3, 'Bike', 'manual', '');
...
(14, 'Chienlo Joseph Mejia', 'chienlo@gmail.com', '123'),
(15, 'Chienlo Joseph Mejia', 'chienlo@gmail.com', '123'),
(16, 'Chienlo Joseph Mejia', 'chienlo@gmail.com', '123'),
(17, 'Chienlo Joseph Mejia', 'chienlo@gmail.com', '123'),
(18, 'Chienlo Joseph Mejia', 'a@gmail.com', 'gdsgds'),
(19, 'Chienlo Joseph Mejia', 'a@gmail.com', 'gdsgds'),
(20, 'Chienlo Joseph Mejia', 'a@gmail.com', 'gdsgds'),
(21, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(22, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(23, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(24, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(25, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(26, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(27, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(28, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(29, 'Chienlo Joseph Mejia', 'a@gmail.com', '123'),
(30, 'Chienlo Joseph Mejia', 'a@gmail.com', '123');
...
INSERT INTO `feedback` (`id`, `name`, `message`, `choices1`, `choices2`, `choices3`, `choices4`) VALUES
(37, 'Chienlo', 'yes', '(1)-Hindi nasiyahan', '(1)-Hindi nasiyahan', '(1)-Hindi nasiyahan', '(1)-Hindi nasiyahan'),
(38, 'Chienlo', 'yes', '(4)-Lubos na nasisiyahan', '(4)-Lubos na nasisiyahan', '(4)-Lubos na nasisiyahan', '(4)-Lubos na nasisiyahan'),
(40, 'Chienlo', 'wew', '(3)-Nasiyahan', '(3)-Nasiyahan', '(3)-Nasiyahan', '(3)-Nasiyahan');
...
INSERT INTO `feedbackadmin` (`id`, `name`, `message`, `choices1`, `choices2`, `choices3`, `choices4`) VALUES
(1, 'Chienlo', 'yes', '(2)-Hindi gaanong nasiyahan', '(2)-Hindi gaanong nasiyahan', '(3)-Nasiyahan', '(1)-Hindi nasiyahan'),
(3, 'james', 'yes', '(1)-Hindi nasiyahan', '(2)-Hindi gaanong nasiyahan', '(3)-Nasiyahan', '(4)-Lubos na nasisiyahan');

-- --------------------------------------------------------

--
-- Table structure for table `feedbacklaspinas`
--

CREATE TABLE `feedbacklaspinas` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `message` text NOT NULL,
  `choices1` text NOT NULL,
...
--
-- Dumping data for table `feedbacklaspinas`
--

INSERT INTO `feedbacklaspinas` (`id`, `name`, `message`, `choices1`, `choices2`, `choices3`, `choices4`) VALUES
(1, '0', 'wew', 'Nasiyahan', 'Nasiyahan', 'Nasiyahan', 'Nasiyahan'),
(2, 'james', 'yes', 'Hindi gaanong nasiyahan', 'Lubos na nasisiyahan', 'Hindi gaanong nasiyahan', 'Hindi gaanong nasiyahan'),
(5, 'Chienlo', 'yes', '(3)-Nasiyahan', '(3)-Nasiyahan', '(3)-Nasiyahan', '(3)-Nasiyahan');

-- --------------------------------------------------------

--
-- Table structure for table `feedbacknovaliches`
--

CREATE TABLE `feedbacknovaliches` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `message` text NOT NULL,
  `choices1` text NOT NULL,
...
--
-- Dumping data for table `feedbacknovaliches`
--

INSERT INTO `feedbacknovaliches` (`id`, `name`, `message`, `choices1`, `choices2`, `choices3`, `choices4`) VALUES
(1, 'Chienlo', 'yes', '(3)-Nasiyahan', '(2)-Hindi gaanong nasiyahan', '(2)-Hindi gaanong nasiyahan', '(3)-Nasiyahan');

-- --------------------------------------------------------

--
-- Table structure for table `feedbackpila`
--

CREATE TABLE `feedbackpila` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `message` text NOT NULL,
  `choices1` text NOT NULL,
...
--
-- Dumping data for table `feedbackpila`
--

INSERT INTO `feedbackpila` (`id`, `name`, `message`, `choices1`, `choices2`, `choices3`, `choices4`) VALUES
(1, 'Chienlo Joseph Mejia', 'yes', '(2)-Hindi gaanong nasiyahan', '(1)-Hindi nasiyahan', '(1)-Hindi nasiyahan', '(3)-Nasiyahan');
...
CREATE TABLE `posts` (
  ...
  `ADL` text NOT NULL,
  `PSA_NSO` text NOT NULL,
  `parentconsent` varchar(255) NOT NULL,
  `medicalcerti` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(70, 0, 'chienlo', 9, 'rex', 'gd', '', '', '2023-11-15', 'Gp_logo.jpg', 'gds', '', 'Complete', 0, 'Picture1.jpg', 'Picture1.jpg', 'gds', 'Picture1.jpg'),
(71, 0, 'chienlo', 8, 'chienlokyut', 'blk37', '', '', '2023-11-15', 'Picture1.jpg', 'gvds', '', 'Complete', 0, 'Gp_logo.jpg', 'Picture1.jpg', '', 'Picture1.jpg'),
(74, 0, 'admnin', 8, 'chienlokyut', 'gds', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Not_Complete', 0, '../images/Picture1.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg');
...
(4, 0, 'wew', 5, 'chienlo', 'fsdgs', '', '', '2023-05-16', '', 'gds', '', 'Not_Complete', 0, 'wew', 'tr', 'fsa', 'gds'),
(5, 0, 'chienlo', 6, 'chienlokyut', 'fsdgs', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Not_Complete', 0, '../images/2x2.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg'),
(6, 0, 'chienlo', 6, 'rex', 'gds', '', '', '2023-11-15', '../images/2x2.jpg', '123', '', 'Complete', 0, '../images/Gp_logo.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg'),
(7, 0, 'chienlo', 6, 'chienlokyut', 'fsd', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Complete', 0, '../images/Picture1.jpg', '../images/2x2.jpg', 'gds', '../images/Picture1.jpg');
...
(16, 0, 'chienlo', 2, 'chienlokyut', 'blk37', '', '', '2023-10-31', '', 'gds', '', 'Complete', 0, 'gds', 'gds', 'gds', 'gds'),
(17, 0, 'chienlo', 4, 'chienlokyut', 'blk37', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Complete', 0, '../images/Picture1.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg'),
(18, 0, 'chienlo', 4, 'chienlokyut', 'gds', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Not_Complete', 0, '../images/Picture1.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg'),
(19, 0, 'chienlo', 4, 'chienlokyut', 'fsdgs', '', '', '2023-11-15', '../images/Gp_logo.jpg', '123', '', 'Not_Complete', 0, '../images/Gp_logo.jpg', '../images/Gp_logo.jpg', 'gds', '../images/Gp_logo.jpg'),
(20, 0, 'chienlo', 4, 'chienlokyut', 'fsd', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Not_Complete', 0, '../images/Picture1.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg');
...
(4, 0, 'chienlo', 3, 'chienlokyut', 'blk37', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Complete', 0, '../images/Picture1.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg'),
(5, 0, 'chienlo', 3, 'chienlokyut', 'gd', '', '', '2023-11-15', '../images/Picture1.jpg', '123', '', 'Not_Complete', 0, '../images/Picture1.jpg', '../images/Picture1.jpg', 'gds', '../images/Picture1.jpg');
...
(1, 'admin', 'admin', '$2y$10$x7MDhF9pMmffVqf7dkdlA.JUexQAJktl6zCyPMyx7bVV0uHSylGti', 'user-default.png', '2023-11-15 02:10:34'),
...
(1, 'admin', 'admin', '$2y$10$sXyZSppOFOJ/8ue.5t.WLeAcUEDygS4o0Ax5N7R1xbuE9iW9kFjm.', 'user-default.png', '2023-11-14 21:38:48'),
...
(1, 'admin', 'admin', '$2y$10$cpD4jZEFaPeNAdldl7jO.eQJ2l/ochsdwijnNiwpUcs6eCDw/uK0O', 'user-default.png', '2023-11-18 17:11:52'),
...
(1, 'admin', 'admin', '$2y$10$ImNN35k5BLWmE08TBxX6K.TWsK/kc6AhIffe1DClwyPydT00NFoJC', 'user-default.png', '2023-11-14 21:38:58'),
...
INSERT INTO `userslaspinas` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`, `paycourse`, `Not_approved`) VALUES
...
(11, 'user', '123', 'Chienlo', 'Mejia', 'aa@gmail.com', '09662733608', '', 'Admin', 0, 'comment', 'read', '2023-11-18 16:33:36', '', 'Staff_Registered');
...
INSERT INTO `usersmarikina` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`, `paycourse`, `Not_approved`) VALUES
...
(22, 'ivan', '123', 'Chienlo', 'Mejia', 'a@yahoo.com', '09662733608', 'gcash.png', 'Enroll', 0, 'comment', 'read', '2023-11-05 01:11:30', '', ''),
(24, 'user', '123', 'Chienlo', 'Mejia', 'a@gmail.com', '09662733608', 'gcash.png', 'Enroll', 0, 'comment', 'unread', '2023-11-14 20:29:48', 'TDC', ''),
(26, 'chienlo', '123', 'Chienlo', 'Mejia', 'wew@gmail.com', '09662733608', 'gcash.png', 'Not Enroll', 0, 'comment', 'unread', '2023-11-14 20:32:58', 'TDC', ''),
(31, 'rex', '123', 'Chienlo', 'Mejia', 'a@gmail.com', '09662733608', '', 'Admins', 0, 'comment', 'read', '2023-11-18 02:26:41', '', ''),
(36, 'uu', '123', 'Chienlo', 'Mejia', 'a@yahoo.com', '09662733608', '', 'Admin', 0, 'comment', 'read', '2023-11-18 15:15:06', '', 'Staff_Registered'),
(38, 'chienlo', '123', 'Chienlo', 'Mejia', 'ivan@gmail.com', '09662733608', '', 'Admin', 0, 'comment', 'read', '2023-11-18 16:22:10', '', 'Staff_Registered');
...
INSERT INTO `usersnovaliches` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`, `paycourse`, `Not_approved`) VALUES
(5, 'admin', '123', 'chienlo', 'mejia', '123@gmail.com', '32532', 'user_default.jpg', 'Admin', 12, '', '', '2023-10-22 09:39:36', '', ''),
(8, 'ivan', '123', 'addition', '', 'a@gmail.com', '09662733608', 'user_default.jpg', 'Not Enroll', 0, 'comment', 'unread', '2023-11-05 02:49:16', '', ''),
(9, 'user', '123', 'Chienlo', 'Mejia', 'a@gmail.com', '09662733608', 'gcash.png', 'Enroll', 0, 'comment', 'unread', '2023-11-17 21:51:48', 'TDC', ''),
(10, 'user', '123', 'Chienlo', 'Mejia', 'ivan@gmail.com', '09662733608', '', 'Staff', 0, 'comment', 'read', '2023-11-18 17:08:54', '', 'Staff_Registered');
...
INSERT INTO `userspila` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`, `paycourse`, `Not_approved`) VALUES
(1, 'admin', '123', 'gds', 'gds', '123@gmail.com', '342423', '', 'Admin', 0, '', '', '2023-10-22 09:40:41', '', ''),
(7, 'chienlo', '123', 'Chienlo', 'Mejia', 'wew@gmail.com', '096622132733608', 'gcash.png', 'Enroll', 0, 'comment', 'unread', '2023-11-12 23:18:18', 'PDC', ''),
(8, 'user', '123', 'Chienlo', 'Mejia', 'a@gmail.com', '09662733608', 'gcash.png', 'Enroll', 0, 'comment', 'unread', '2023-11-17 21:58:04', 'TDC', ''),
(9, 'user', '123', 'Chienlo', 'Mejia', '123@gmail.com', '09662733608', '', 'Staff', 0, 'comment', 'unread', '2023-11-18 17:33:50', '', 'Staff_Registered'),
(10, 'chienlo', '123', 'Chienlo', 'Mejia', '123@gmail.com', '09662733608', '', 'Staff', 0, 'comment', 'unread', '2023-11-18 17:35:08', '', 'Staff_Registered');
...
--
-- Indexes for table `feedbacklaspinas`
--
ALTER TABLE `feedbacklaspinas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `feedbacknovaliches`
--
ALTER TABLE `feedbacknovaliches`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `feedbackpila`
--
ALTER TABLE `feedbackpila`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `categories`
  MODIFY `cat_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
...
--
-- AUTO_INCREMENT for table `feedbacklaspinas`
--
ALTER TABLE `feedbacklaspinas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `feedbacknovaliches`
--
ALTER TABLE `feedbacknovaliches`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `feedbackpila`
--
ALTER TABLE `feedbackpila`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
