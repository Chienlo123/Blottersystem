                                ...
                                <tbody>
									...
									<?php 
								     ...
								     ?>
                                       ...
                                       <td> <?php echo "<td><a href='Learnersnovaliches.php?delete=$Learners_id'>Delete</a></td>"; ?></td>
                                       <td> <?php echo "<td><a href='Learnersnovaliches.php?source=update&Learners_id=$Learners_id'>Update</a></td>"; ?></td>
                                      <?php echo "<td><a href='Learnersnovaliches.php?Complete=$Learners_id'>Complete</a></td>"; ?>
                                      <?php echo "<td><a href='Learnersnovaliches.php?Not_Complete=$Learners_id'>Not_Complete</a></td>"; ?>
                                    </tr>
                                    <?php }?>
                                </tbody>
                                </table><?php
