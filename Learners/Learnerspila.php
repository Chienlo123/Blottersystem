<?php include"includes/admin_header.php"; ?>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <?php include"includes/admin_navigationpila.php"; ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            default: ?>
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        $query = "SELECT *  FROM  postspila order by post_id desc";
									...
									<?php 
								     ...
								     ?>
                                       ...
                                       <td> <?php echo "<td><a href='Learnerspila.php?delete=$Learners_id'>Delete</a></td>"; ?></td>
                                       <td> <?php echo "<td><a href='Learnerspila.php?source=update&Learners_id=$Learners_id'>Update</a></td>"; ?></td>
                                      <?php echo "<td><a href='Learnerspila.php?Published=$Learners_id'>Make Published</a></td>"; ?>
                                      <?php echo "<td><a href='Learnerspila.php?remove_from_Published=$Learners_id'>Remove From Published</a></td>"; ?>
                                    </tr>
                                    <?php }?>
                                </tbody>
                                </table><?php
                        ...
                        if (isset($_GET['remove_from_Published'])) {
                            ...
                            $query = "UPDATE postspila SET confirm = 'Pending' WHERE post_id = '$post_idd'";
                        ...
                        if (isset($_GET['Published'])) {
                            ...
                            $query = "UPDATE postspila SET confirm = 'Published' WHERE post_id = '$post_idd'";
