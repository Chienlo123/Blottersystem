...
if (isset($_POST['update-Learners'])) {
	...
	$query = "UPDATE postsnovaliches SET post_title='{$Learners_Name}', user_id='{$curr_user_id}', Address='{$Address}', post_author='{$user_name}', post_category_id={$category}, post_content='{$detail}' WHERE post_id=$edit_Learners_id ";
