<?php 
	...
	if (isset($_POST['insert-Learners'])) {
		...
		if ($category=="" || $Learners_Name=="" || $District=="" || $Address=="" || $Motorcycle=="" || $Light=="" || $Heavy=="" || $detail=="") {
			...
			$query = "INSERT INTO posts(user_id, post_category_id, post_title, post_author, post_image, post_content, Price_m, Price_l, Price_h, Address,ADL,PSA_NSO, District, City) VALUES('{$curr_user_id}', '{$category}', '{$Learners_Name}', '{$user_name}', '{$image}', '{$detail}', '{$Motorcycle}','{$Light}','{$Heavy}','{$Address}','{$ADL}','{$PSA_NSO}','{$District}','{$City}')";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="ADL">
	</div>
	
	<div class="form-group">
		<label for="intermediate-station">PSA/NSO</label>
		<input type="text" class="form-control" name="PSA_NSO">
	</div>
