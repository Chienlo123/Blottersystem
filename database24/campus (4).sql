...
INSERT INTO `categoriesnovaliches` (`cat_id`, `cat_title`) VALUES
(2, 'bikers');
...
(10, 'chienlowewwe', 'arrenjamesvalmoria@yahoo.com', 'gdsgsdgsd');
...
(58, 0, 'wewssssss', 10, 'chienlokyut', 'wew', '', '', '2023-05-16', '', 'gds', '', 'Complete', 0, 'wew', 'tr', 'gds', 'gds'),
(59, 0, 'wew', 14, 'chienlo', 'fsd', '', '', '2023-05-13', '', 'ggfsdzgdz', '', 'Not_Complete', 0, 'gds', 'gds', 'gds', 'gsd'),
(60, 0, 'chienlo', 9, 'chienlokyut', 'fsdgs', '', '', '2023-10-22', '', 'gdsgs', '', 'Pending', 0, 'gds', 'gds', 'gds', 'wew'),
(61, 0, 'Learners6', 8, 'chienlokyut', 'ggd', '', '', '2023-10-22', '', 'gds', '', 'Pending', 0, 'gds', 'gds', 'gds', 'gds'),
(62, 0, 'admnin', 8, 'chienlokyut', 'gd', '', '', '2023-10-22', '', 'gds', '', 'Pending', 0, 'gds', 'gds', 'gds', 'gds'),
(63, 0, 'admnin', 8, 'chienlokyut', 'gd', '', '', '2023-10-22', '', 'gds', '', 'Pending', 0, 'gds', 'gds', 'gds', 'gds'),
(64, 0, 'admnin', 8, 'chienlokyut', 'gd', '', '', '2023-10-22', '', 'gds', '', 'Pending', 0, 'gds', 'gds', 'gds', 'gds'),
(65, 0, 'chienlo', 8, 'chienlokyut', 'gds', '', '', '2023-10-22', '', 'fsda', '', 'Not_Complete', 0, 'gdsg', 'gds', 'gds', 'gds');
...
(4, 0, 'gg', 5, 'chienlo', 'fsdgs', '', '', '2023-05-16', '', 'gds', '', 'Not_Complete', 0, 'wew', 'tr', 'fsa', 'gds');
...
(11, 3, 'Hh', 10, 'chienlokyut123', 'gd', 'bataan', '', '2023-05-03', '', 'gdsgds', '', 'Complete', 0, '', '', '', ''),
(12, 2, 'Chienlo', 10, 'ty', 'blk37', 'abra', 'bucay', '2023-05-03', '', 'gds', '', 'Complete', 0, '', '', '', ''),
(13, 3, 'Hh', 8, 'chienlokyut12345', 'blk37', 'abra', 'bucay', '2023-05-03', '', 'gds', '', 'Not_Complete', 0, '', '', '', ''),
(14, 0, 'gg', 8, 'chienskie', 'gds', '', '', '2023-05-16', '', 'gds', '', 'Not_Complete', 0, 'gds', 'gds', 'gds', 'gds'),
(15, 0, 'shess', 1, 'chienlo', 'ggwp', '', '', '2023-05-16', '', 'gds', '', 'Pending', 0, 'wew', 'fsafas', 'gds', 'gsd');
...
(2, 2, 'james', 2, 'Learners10', 'blk37', 'abra', 'bucay', '2023-05-03', '', 'gfsdg', '', 'Not_Complete', 0, '', '', '', ''),
...
(17, '645ca0407806c', 'Add', 1, 1, 2, 1, '2023-05-11 08:16:31', 'enabled'),
...
(27, '646f07876d579', 'Ano Pangalan Ko', 1, 1, 2, 1, '2023-05-25 07:01:52', 'enabled');
...
(1, '645de144713d1', 'Add', 1, 1, 2, 1, '2023-05-12 06:48:57', 'enabled');
...
(1, '645df1e80f5ee', 'Wew', 1, 1, 2, 1, '2023-05-12 07:59:59', 'enabled');
...
(1, 'admin', 'admin', '$2y$10$sXyZSppOFOJ/8ue.5t.WLeAcUEDygS4o0Ax5N7R1xbuE9iW9kFjm.', 'user-default.png', '2023-05-22 02:00:05'),
(2, 'chienlo', 'chienlo', '$2y$10$9mt70bLBp02waCaprFoYCOzrJLKXEZvHqh/J3VNHJR1RbprLa/9DC', 'user-default.png', '2023-05-12 17:52:00'),
(3, 'gg', 'gg', '$2y$10$jyJpWRBwBNmk5/V9fYELCuWGz4FHoxYf0ihHveY3PyXZMm6KqHJyS', 'user-default.png', '2023-05-12 17:52:52'),
(4, 'rex', 'rex', '$2y$10$DW8WI5LWOUO3EmdGe7ysyefL03sCOO1IZbzhQKy4QB1J3B6CNduuK', 'user-default.png', '2023-05-12 18:15:16');
...
INSERT INTO `userslaspinas` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`) VALUES
(2, 'admin', '123', 'renzy', 'revira', 'wtf@gmail.com', '3232132', '', 'Admin', 0, '', '', '2023-10-22 09:38:15'),
(6, 'user', '123', 'chienlo', 'mejia', 'wew@gmail.com', '32532', '', 'Enroll', 23, '', '', '2023-10-22 09:38:15');
...
CREATE TABLE `usersmarikina` (
  ...
  `payment` int(255) NOT NULL,
  `p_p` varchar(255) DEFAULT 'user-default.png',
  `last_seen` varchar(255) NOT NULL DEFAULT current_timestamp(),
  `type` text NOT NULL,
  `status` text NOT NULL,
  `date` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usersmarikina` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `p_p`, `last_seen`, `type`, `status`, `date`) VALUES
(1, 'admin', '123', 'chienlo', 'mejia', 'wew@gmail.com', '242142', 'user_default.jpg', 'Admin', 33, 'user-default.png', '2023-05-22 02:01:02', '', '', '2023-10-22 09:37:32'),
(10, 'user', '123', 'chienlo', 'mejia', 'wew1@gmail.com', '21421', 'user_default.jpg', 'Enroll', 0, 'user-default.png', '2023-05-16 16:16:45', '', '', '2023-10-22 09:37:32'),
(11, 'ericka', '123', 'ericka', 'tamayo', 'ivan@gmail.com', '32532', 'user_default.jpg', 'Enroll', 0, 'user-default.png', '2023-05-25 15:07:20', '', '', '2023-10-22 09:37:32');
...
INSERT INTO `usersnovaliches` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`) VALUES
(5, 'admin', '123', 'chienlo', 'mejia', '123@gmail.com', '32532', 'user_default.jpg', 'Admin', 12, '', '', '2023-10-22 09:39:36'),
(7, 'user', '123', 'chienlo', 'mejia', 'aa@gmail.com', '2323', 'user_default.jpg', 'Enroll', 12, '', '', '2023-10-22 09:39:36');
...
INSERT INTO `userspila` (`user_id`, `username`, `password`, `name`, `user_lastname`, `email`, `user_phoneno`, `user_image`, `user_role`, `payment`, `type`, `status`, `date`) VALUES
(1, 'admin', '123', 'gds', 'gds', '123@gmail.com', '342423', '', 'Admin', 0, '', '', '2023-10-22 09:40:41'),
(2, 'user', '123', 'wew', 'wew', 'wew@gmail.com', '32532', '', 'Not Enroll', 12, '', '', '2023-10-22 09:40:41');
