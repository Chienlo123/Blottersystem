...
?>
    <div class="well" style="background-color: #f8f9fa; border: 1px solid #dce0e5; border-radius: 10px; padding: 20px;">
        <h4 style="color: #1877f2; text-align: center; font-size: 24px; font-weight: bold;">Login Admin</h4>
        <form action="includes/loginadmin.php" method="post">
            ...
            <div style="text-align: center; margin-top: 10px;">
                <a href="includes/forgetpassadmin/forgot_password.php" style="text-decoration: none; color: #1877f2;">Forgot Password?</a>
            </div>
        </form>
    </div>
<?php
