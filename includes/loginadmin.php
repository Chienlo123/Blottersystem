   ...
   $query = "SELECT * FROM usersadmin WHERE username = '$username' AND password='$password'";
    ...
    if($row < 1)
    {
	  ...
	  if ($db_user_role == 'Admin') {
                  ...
                  echo "<script> document.location.href='../admin/reportadmin.php';</script>";
				...
				echo "<script>alert('You Are Successfully logged')</script>";
                  ...
                  echo "<script> document.location.href='../Learners/reportadmin.php';</script>";
				...
				echo "<script>alert('You Are Successfully logged')</script>";
                  ...
                  echo "<script> document.location.href='../reportadmin.php';</script>";
