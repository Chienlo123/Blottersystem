        ...
        <div class="col-md-6">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($new_password == $confirm_password) {
                    ...
                    $query = "UPDATE userspila SET password = '$confirm_password' WHERE email = '$email'";
                    $result = mysqli_query($connection, $query);

                    if ($result) {
                        echo '<div class="alert alert-success mt-3">Password reset successfully. You can now <a href="../../indexpila.php">login</a> with your new password.</div>';
                    } else {
