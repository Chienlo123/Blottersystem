...
<?php 
 ...
 if(isset($_POST['login'])){
   ...
   $query = "SELECT * FROM usersnovaliches WHERE username = '$username' AND password='$password'";
    ...
    if($row < 1)
    {
                  ...
                  echo "<script> document.location.href='../indexnovaliches.php';</script>";
    }
    else{
	  ...
	  if ($db_user_role == 'Admin') {
				...
				echo "<script>alert('You Are Successfully logged')</script>";
                  ...
                  echo "<script> document.location.href='../Learners/indexnovaliches.php';</script>";
