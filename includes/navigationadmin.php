                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    if(isset($_SESSION['s_username'])) {
                        if ($_SESSION['s_role']=='Admin') {
                            ?>
                            <li>
                                <a href="admin/reportadmin.php"><i class="fa fa-fw fa-child"></i>Admin</a>
                            </li>
                    ...
                    if(isset($_SESSION['s_username'])) {
                        if ($_SESSION['s_role']=='Learners') {
                            ?>
                            <li>
                                <a href="Learners/indexadmin.php"><i class="fa fa-fw fa-child"></i>Add Learners</a>
                            </li>
				 ...
				 <?php 
                    ...
                    if(!isset($_SESSION['s_username'])) {
                            ...
                            ?>
                          <li>
                                <a href="admin/indexadmin.php"><i class="fa fa-fw fa-child"></i>Admin</a>
                            </li>
