    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #182c39;" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="reportlaspinas.php"><p style="color:white"> Motorcycle <span style="color:red"> DRIVING </span>School</p></a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    if(isset($_SESSION['s_username'])) {
                        if ($_SESSION['s_role']=='Admin') {
                            ?>
                            <li>
                                <a href="admin/reportlaspinas.php"><i class="fa fa-fw fa-child"></i>Admin</a>
                            </li>
                    ...
                    if(isset($_SESSION['s_username'])) {
                        if ($_SESSION['s_role']=='Learners') {
                            ?>
                            <li>
                                <a href="Learners/indexlaspinas.php"><i class="fa fa-fw fa-child"></i>Add Learners</a>
                            </li>
                    ...
                    <li>
                        <a href="indexlaspinas.php">Home</a>
                    </li>
             
					  <li>
                        <a href="aboutUslaspinas.php">About</a>
                    </li>
                    <li>
                        <a href="serviceslaspinas.php">Services</a>
                    </li>
					
					
						
					 <li>
                        <a href="contactlaspinas.php">Contact</a>
                    </li> 
					
						<li>
                        <a href="chatlaspinas/index.php">Chat Box</a>
                    </li> 
