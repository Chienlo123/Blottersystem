...
?>
    <div class="well" style="background-color: #f8f9fa; border: 1px solid #dce0e5; border-radius: 10px; padding: 20px;">
        <h4 style="color: #1877f2; text-align: center; font-size: 24px; font-weight: bold;">Login Pila</h4>
        <form action="includes/loginpila.php" method="post">
            ...
            <div style="text-align: center; margin-top: 10px;">
                <a href="includes/forgetpasspila/forgot_password.php" style="text-decoration: none; color: #1877f2;">Forgot Password?</a>
				<a href="registrationpila.php" style="text-decoration: none; color: #1877f2;">Registration</a>
            </div>
        </form>
    </div>
<?php
