...
<div class="container">
    ...
    <span class="text-primary">Enter Your Email Account Muntinlupa</span>
    <br>
    <small class="text-muted">to reset your password</small>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $query = "SELECT * FROM usersmarikina WHERE email = '$email'";
                        ...
                        echo '<a href="../../index.php" class="btn btn-secondary btn-block mt-2">Back to Login</a>';
                    } else {
