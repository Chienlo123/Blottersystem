...
$query = "INSERT INTO userspila(username, password, name, user_lastname, email, user_phoneno, user_role,paycourse, user_image,type, status, date) VALUES('$username', '$password', '$name', '$lastname', '$email', '$phone_no', '$u_role','$pay_course', '$image', 'comment', 'unread', CURRENT_TIMESTAMP) ";
