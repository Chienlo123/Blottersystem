...
<title> Exam Motorcycle Driving school</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Exam Motorcycle Driving school</span></div>
<?php
...
echo '<span class="pull-right top title1">
  <span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello, ' . $name . '&nbsp;&nbsp;|&nbsp;&nbsp;
  <a href="logout.php?q=account.php" style="color:black">
...
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="videoupload/index.php?q=3">Video</a></li>
        <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
...
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">History</a></li>
...
if (@$_GET['q'] == 0) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiznovaliches ORDER BY date DESC") or die('Error');
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Status</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
  ...
  <td style="vertical-align:middle"><b><a href="update.php?deidquiz=' . $eid . '" class="btn logb" style="color:#FFFFFF;background:lightblue;font-size:12px;padding:5px;">&nbsp;<span><b>Disable</b></span></a></b></td></tr>';
        } else {
...
if (@$_GET['q'] == 1) {
    ...
    $result = mysqli_query($con, "SELECT * FROM usersnovaliches") or die('Error');
    echo '<div class="panel" style="background-color: lightyellow;"><table class="table table-striped title1">
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Phno</b></td><td style="vertical-align:middle"><b>Option</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $name      = $row['name'];
        ...
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $username1 . '</td><td style="vertical-align:middle">' . $user_phoneno . '</td>
...
if (@$_GET['fid']) {
    echo '<br />';
    $id = @$_GET['fid'];
    $result = mysqli_query($con, "SELECT * FROM feedbacknovaliches WHERE id='$id' ") or die('Error');
    while ($row = mysqli_fetch_array($result)) {
        $name     = $row['name'];
        $subject  = $row['subject'];
        $date     = $row['date'];
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Topic</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
  ...
  <td style="vertical-align:middle"><b><a href="update.php?q=rmquiz&eid=' . $eid . '" class="btn" style="margin:0px;background:lightblue;color:white">&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
if (@$_GET['q'] == 6) {
   $q=mysqli_query($con,"SELECT * FROM historynovaliches" )or die('Error197');
echo  '<div class="panel title" style="background-color: lightyellow;">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>S.N.</b></td><td><b>Username</b></td><td><b>Title</b></td><td><b>Level</b></td><td><b>Correct</b></td><td><b>Wrong<b></td><td><b>Score</b></td><td><b>Date</b></td>';
$c=2;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
$qa=$row['level'];
$q23=mysqli_query($con,"SELECT title FROM quiznovaliches WHERE  eid='$eid' " )or die('Error208');
while($row=mysqli_fetch_array($q23) )
{
$title=$row['title'];
}
$c++;
echo '<tr><td>'.$c.'</td><td>'.$username.'</td><td>'.$title.'</td><td>'.$level.'</td><td>'.$correct.'</td><td>'.$wrong.'</td><td>'.$score.'</td><td>'.$date.'</td></tr>';
}
echo'</table></div>';
}
?>
